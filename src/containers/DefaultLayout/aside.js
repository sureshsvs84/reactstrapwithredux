...
const basePath = configuration.siteUrl;
            ...
            <ListGroup className="list-group-accent" tag={'div'}>
              ...
              <ListGroupItem action tag="a" href="#" className="list-group-item-accent-warning list-group-item-divider">
                <div className="avatar float-right">
                  <img className="img-avatar" src={basePath+'assets/img/avatars/7.jpg'} alt="admin@bootstrapmaster.com"></img>
                </div>
              ...
              <ListGroupItem action tag="a" href="#" className="list-group-item-accent-info list-group-item-divider">
                <div className="avatar float-right">
                  <img className="img-avatar" src={basePath+'assets/img/avatars/4.jpg'} alt="admin@bootstrapmaster.com"></img>
                </div>
              ...
              <ListGroupItem action tag="a" href="#" className="list-group-item-accent-danger list-group-item-divider">
                ...
                <div className="avatars-stack mt-2">
                  <div className="avatar avatar-xs">
                    <img src={basePath+'assets/img/avatars/2.jpg'} className="img-avatar" alt="admin@bootstrapmaster.com" />
                  </div>
                  <div className="avatar avatar-xs">
                    <img src={basePath+'assets/img/avatars/3.jpg'} className="img-avatar" alt="admin@bootstrapmaster.com" />
                  </div>
                  <div className="avatar avatar-xs">
                    <img src={basePath+'assets/img/avatars/4.jpg'} className="img-avatar" alt="admin@bootstrapmaster.com" />
                  </div>
                  <div className="avatar avatar-xs">
                    <img src={basePath+'assets/img/avatars/5.jpg'} className="img-avatar" alt="admin@bootstrapmaster.com" />
                  </div>
                  <div className="avatar avatar-xs">
                    <img src={basePath+'assets/img/avatars/6.jpg'} className="img-avatar" alt="admin@bootstrapmaster.com" />
                  </div>
                </div>
              </ListGroupItem>
              ...
              <ListGroupItem action tag="a" href="#" className="list-group-item-accent-primary list-group-item-divider">
                ...
                <div className="avatars-stack mt-2">
                  ...
                  <div className="avatar avatar-xs">
                    <img src={basePath+'assets/img/avatars/7.jpg'} className="img-avatar" alt="admin@bootstrapmaster.com" />
                  </div>
                  <div className="avatar avatar-xs">
                    <img src={basePath+'assets/img/avatars/8.jpg'} className="img-avatar" alt="admin@bootstrapmaster.com" />
                  </div>
                </div>
              </ListGroupItem>
            </ListGroup>
